...
router.get("/", (req: Request, res: Response) => {
  ...
  router.post("/addNew", (req: Request, res: Response) => {
    ...
    pracownik
      ...
      .catch((error: any) => {
        res.send("Błędne dane pracownika, proszę sprawdzić format wprowadzonych danych");
      });
  });
  ...
  router.delete("/deleteSingle/:id", (req: Request, res: Response) => {
    Pracownik.findByIdAndRemove(req.params.id)
      ...
      .catch((err: any) => {
        res.send("pracownika o takim id nie ma w bazie lub został wcześniej usunięty")
      });
  });
